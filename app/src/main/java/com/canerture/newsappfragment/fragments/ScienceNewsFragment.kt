...
import com.canerture.newsappfragment.databinding.FragmentScienceNewsBinding
...
class ScienceNewsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_science_news, container, false)
        return binding.root
    }
    ...
    companion object {
        ...
        @JvmStatic
        fun scienceNewsInstance(newsModel: NewsModel) =
