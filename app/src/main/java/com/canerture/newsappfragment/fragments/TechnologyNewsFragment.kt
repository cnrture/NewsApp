...
import com.canerture.newsappfragment.databinding.FragmentTechnologyNewsBinding
...
class TechnologyNewsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_technology_news, container, false)
        return binding.root
    }
    ...
    companion object {
        ...
        @JvmStatic
        fun techNewsInstance(newsModel: NewsModel) =
